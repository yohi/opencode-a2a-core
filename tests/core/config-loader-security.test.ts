...
describe('loadConfig Security', () => {
  it('prevents prototype pollution', async () => {
    ...
    try {
      ...
      expect(Object.prototype.hasOwnProperty.call(pluginCfg, '__proto__')).toBe(false);
      expect(Object.prototype.hasOwnProperty.call(pluginCfg, 'constructor')).toBe(false);
